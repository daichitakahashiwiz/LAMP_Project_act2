<?php
/* Smarty version 3.1.33, created on 2019-07-09 11:14:23
  from '/home/tmD2019/public_html/user/Smarty/templates/admin/u_check.tmpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d23f87f6d2eb6_63642400',
...
function content_5d23f87f6d2eb6_63642400 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ja">
<head>
		<meta charset="UTF-8">
														...
														<div class="row">
																<div class="col-sm-12 col-4"> 全体進捗率
																		<div class="progress" style="height: 30px;">
																				<div id="answer_progress_all" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow=@aria_valuenow aria-valuemin="0" aria-valuemax="100">
												...
												<div class="container">
														<div class="row">
																<div class="col-sm-12 col-4"> 遺品の整理（４項目）
																		<div class="progress" style="height: 30px;">
																				<div id="answer_progress_1" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow=@aria_valuenow aria-valuemin="0" aria-valuemax="100">
														...
														<div id="tohoku_1">
																<div class="container">
																		<div class="row">
																				...
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="2" data-savekey="2" class="save-state1">遺品の譲渡先の決定</p> 　 </div>
																		</div>
																		<!--/.row-->
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="3" data-savekey="3" class="save-state1">ペットの譲渡先の決定</p> 　 </div>
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="4" data-savekey="4" class="save-state1">デジタルデータの整理</p> 　 </div>
																		</div>
																		<!--/.row-->
																</div>
														</div>
														<div class="container">
																<div class="row">
																		<div class="col-sm-12 col-4"> 介護・医療（４項目）
																				<div class="progress" style="height: 30px;">
																						<div id="answer_progress_2" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow=@aria_valuenow aria-valuemin="0" aria-valuemax="100">
														...
														<div id="tohoku_2">
																<div class="container">
																		<div class="row">
																				...
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="6" data-savekey="6" class="save-state1">かかりつけの病院の決定</p> 　 </div>
																		</div>
																		<!--/.row-->
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
																				...
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="8" data-savekey="8" class="save-state1">自分が望む終末医療の決定</p> 　 </div>
																		</div>
																		<!--/.row-->
																</div>
																<!--/.container-->
														...
														<div class="container">
																<div class="row">
																		<div class="col-sm-12 col-4"> 葬儀（６項目）
																				<div class="progress" style="height: 30px;">
																						<div id="answer_progress_3" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow=@aria_valuenow aria-valuemin="0" aria-valuemax="100">
														...
														<div id="tohoku_3">
																<div class="container">
																		<div class="row">
																				...
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="10" data-savekey="10" class="save-state1">葬儀に呼ぶ人の決定</p>　 </div>
																		</div>
																		<!--/.row-->
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="11" data-savekey="11" class="save-state1">葬儀の予算の用意</p>　 </div>
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="12" data-savekey="12" class="save-state1">宗派やお寺等の希望を伝えたか</p>　 </div>
																		</div>
																		<!--/.row-->
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
														...
														<div class="container">
																<div class="row">
																		<div class="col-sm-12 col-4"> お墓（４項目）
																				<div class="progress" style="height: 30px;">
																						<div id="answer_progress_4" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow=@aria_valuenow aria-valuemin="0" aria-valuemax="100">
														...
														<div id="tohoku_4">
																<div class="container">
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="15" data-savekey="15" class="save-state1">供養の方法の決定</p> 　 </div>
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="16" data-savekey="16" class="save-state1">お墓の管理人の決定</p> 　 </div>
																		</div>
																		<!--/.row-->
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="17" data-savekey="17" class="save-state1">維持費や購入費の用意</p> 　 </div>
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="18" data-savekey="18" class="save-state1">お墓の購入先の決定</p>　 </div>
																		</div>
																		<!--/.row-->
																</div>
																<!--/.container-->
														...
														<div class="container">
																<div class="row">
																		<div class="col-sm-12 col-4"> お金と住まい（３項目）
																				<div class="progress" style="height: 30px;">
																						<div id="answer_progress_5" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow=@aria_valuenow aria-valuemin="0" aria-valuemax="100">
														...
														<div id="tohoku_5">
																<div class="container">
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="19" data-savekey="19" class="save-state1">老後の資金の用意</p>　 </div>
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="20" data-savekey="20" class="save-state1">「終のすみか」の決定</p> 　 </div>
																		</div>
																		<!--/.row-->
																		<div class="row">
																				<div class="col-sm-1 col-0"> </div>
																				<div class="box2 col-sm-4 col-4">
																						<p><input type="checkbox" name="item[]" value="21" data-savekey="21" class="save-state1">不動産の譲渡先の決定</p> 　 </div>
																				<div class="col-sm-1 col-0"> </div>
																				<!--/.row-->
																		</div>
																		<!--/.container-->
												...
												<div class="container">
														<div class="row">
																<div class="col-sm-12 col-4"> 財産・遺産（３項目）
																		<div class="progress" style="height: 30px;">
																				<div id="answer_progress_6" class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow=@aria_valuenow aria-valuemin="0" aria-valuemax="100">
												...
												<div id="tohoku_6">
														<div class="container">
																<div class="row">
																		<div class="col-sm-1 col-0"> </div>
																		<div class="box2 col-sm-4 col-4">
																				<p><input type="checkbox" name="item[]" value="22" data-savekey="22" class="save-state1">誰にいくら残すのかを決定</p>　 </div>
																		<div class="col-sm-1 col-0"> </div>
																		<div class="box2 col-sm-4 col-4">
																...
																<div class="row">
																		<div class="col-sm-1 col-0"> </div>
																		<div class="box2 col-sm-4 col-4">
																				<p><input type="checkbox" name="item[]" value="24" data-savekey="24" class="save-state1">エンディングノートの作成</p> 　 </div>
																		<div class="col-sm-1 col-0"> </div>
																		<!--/.row-->
																</div>
																<!--/.container-->
