<?php
/* Smarty version 3.1.33, created on 2019-07-09 15:25:56
  from '/home/tmD2019/public_html/user/Smarty/templates/admin/contact_us.tmpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d243374cc2216_55978931',
...
function content_5d243374cc2216_55978931 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ja">
...
">
							<?php if (isset($_smarty_tpl->tpl_vars['err_array']->value['c_name'])) {?><br /><span class="red"><?php echo $_smarty_tpl->tpl_vars['err_array']->value['c_name'];?>
</span><?php }?></td>
                        </tr>
                        <tr>
                            <th>メールアドレス※</th>
...
">
							<?php if (isset($_smarty_tpl->tpl_vars['err_array']->value['c_mail'])) {?><br /><span class="red"><?php echo $_smarty_tpl->tpl_vars['err_array']->value['c_mail'];?>
</span><?php }?></td>
                        </tr>
                        <tr>
                            <th>メールアドレス(再確認)※</th>
...
">
							<?php if (isset($_smarty_tpl->tpl_vars['err_array']->value['c_mail_sai'])) {?><br /><span class="red"><?php echo $_smarty_tpl->tpl_vars['err_array']->value['c_mail_sai'];?>
</span><?php }?></td>
                        </tr>
                        <tr>
                            <th>お問い合わせ内容※</th>
                            <td><textarea name="c_q" cols="30" rows="10" class="wl" value="<?php echo htmlspecialchars($_POST['c_q'], ENT_QUOTES, 'UTF-8', true);?>
"></textarea>
                            <?php if (isset($_smarty_tpl->tpl_vars['err_array']->value['c_q'])) {?><br /><span class="red"><?php echo $_smarty_tpl->tpl_vars['err_array']->value['c_q'];?>
</span><?php }?></td>
                        </tr>
                    </table>
