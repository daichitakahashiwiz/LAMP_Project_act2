...
function content_5d246c6dccb701_50963353 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="ja">
...
" method="post">
												<ul class="row justify-content-around" id="ubutton">
													<li>
														...
														<input type="button" value="削除確認" onClick="javascript:del_func_form(<?php echo $_SESSION['DTeam_user']['user_id'];?>
,'【<?php echo $_SESSION['DTeam_user']['user_name'];?>
】')" />
