				...
				<div class="container login-container">
					<div class="row">
						<div class="col-md-6 login-form-2">
							<h1>パスワードの再設定</h1>
								<form action="login_update4.php" >
									<!-- <div class="alert alert-dismissible alert-danger">
										<strong>メールアドレスまたはパスワードが正しくありません</strong> 
									</div> -->
									<div class="form-group"  >
                                    <font color="white">新しいパスワード</font>
										<input type="password" class="form-control" placeholder="パスワード" value="" />
									</div>
                                    <div class="form-group"  >
                                    <font color="white">再入力</font>
										<input type="password" class="form-control" placeholder="再入力" value="" />
									</div>
									<!-- <div class="form-group">
										<input type="password" class="form-control" placeholder="パスワード*" value="" />
									</div> -->
									<div class="form-group"  href="login_update4.php">
										<input type="submit" href="login_update4.php" action="login_update4.php" class="btnSubmit" value="送信" />
                                        <a href="login_update4.php"></a>
									</div>

                                    <script>
                                    function checkText() {
                                    //actionメソッドに遷移先のURLを代入する
        　                          document.myform.action = "login_update4.php";
                                    }
                                    </script>
