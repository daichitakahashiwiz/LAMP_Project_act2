		...
		<div class="inner">
			<section class="c3">
				...
				<ul class="row passbtn" id="ubutton">
					<li class="col text-right pr-5"><a href="./plan.html">プランをもっと見る</a></li>
				</ul>
			</section>
		</div>
		<!--/.inner-->
	...
	<div class="contents">
		<div class="inner">
			<section class="c3">
				...
				<!--/.container-->
				<ul class="row passbtn" id="ubutton">
					<li class="col text-right pr-5"><a href="./planConfirmation.html">終活知識をもっと見る</a></li>
				</ul>
			</section>
		</div>
		<!--/.inner-->
	...
	<div class="contents">
		<div class="inner">
			<section class="c3">
				...
				<!--/.container-->
				<ul class="row passbtn" id="ubutton">
					<li class="col text-right pr-5"><a href="./planConfirmation.html">よくある質問をもっと見る</a></li>
				</ul>
			</section>
		</div>
		<!--/.inner-->
