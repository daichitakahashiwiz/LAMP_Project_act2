				...
				<div class="container login-container">
					<div class="row">
						<div class="col-md-6 login-form-2">
							<h1>パスワードが再設定されました</h1>
								<form action="index.php" >
									<!-- <div class="alert alert-dismissible alert-danger">
										<strong>メールアドレスまたはパスワードが正しくありません</strong> 
									</div> -->
									<!-- <div class="form-group"  >
                                    <font color="white">新しいパスワードを入力してください</font>
										<input type="text" class="form-control" placeholder="パスワード"　placeholder="パスワード*" value="" />
									</div>
                                    <font color="white">再入力</font>
										<input type="text" class="form-control" placeholder="再入力"　placeholder="パスワード*" value="" />
									</div> -->
									<!-- <div class="form-group">
										<input type="password" class="form-control" placeholder="パスワード*" value="" />
									</div> -->
									<div class="form-group"  href="index.php">
										<input type="submit" href="index.php" action="index.php" class="btnSubmit" value="OK" />
                                        <a href="index.php"></a>
									</div>
